...
func create(_ buffer: vImageBuffer, _ image: CGImage) -> vImageBuffer {
    vImageBuffer_InitWithCGImage(buffer, image)
    return buffer
}
...
///
/// - Parameters:
///   - rotationConstant: 1, 2, 3 means 90, 180, 270 degree
///   - buffer: You are responsible for releasing it when you are done with it
///     and it will be the return value of ImageProcessor
/// - Returns: ImageProcessor
